...
namespace TaxiFarePrediction_Core
{
    public partial class TaxiFareModel
    {
        public const string RetrainFilePath =  @"C:\Users\milto\source\repos\TaxiFarePrediction\TaxiFarePrediction.Core\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=103,NumberOfIterations=773,MinimumExampleCountPerLeaf=20,LearningRate=0.999999776672986,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.999999776672986,FeatureFraction=0.960915082455526,L1Regularization=2E-10,L2Regularization=0.96270155838238},MaximumBinCountPerFeature=288}));
